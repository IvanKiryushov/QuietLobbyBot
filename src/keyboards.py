...
TRANSLATIONS = {
    "ru": {
        ...
        "success": "Ура!\nТеперь ты можешь писать в чате, добро пожаловать!\n\n💡 <i>Нужен свой Telegram-бот, автоматизация процессов или доработка? Пиши: @kiryvanya</i>",
    ...
    "en": {
        ...
        "success": "Verification passed!\nYou are unmuted in the group, welcome!\n\n💡 <i>Need custom Telegram bot development, process automation, or custom features? Contact: @kiryvanya</i>",
    ...
    "vi": {
        ...
        "success": "Đã xác nhận!\nBạn đã được mở chặn trong nhóm, chào mừng bạn!\n\n💡 <i>Cần thiết kế bot Telegram riêng hoặc tự động hóa quy trình? Liên hệ: @kiryvanya</i>",
